        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <div className="space-y-1.5">
            ...
            <select
              ...
              onChange={(event) =>
                onFieldChange(
                  'engine',
                  event.target.value as FormState['engine'],
                )
              }
          ...
          {form.engine === 'redis' && (
            <div className="space-y-1.5">
              ...
              <Input
                ...
                value={form.dbIndex}
                onChange={(event) =>
                  onFieldChange('dbIndex', event.target.value)
                }
              />
            </div>
          )}
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(event) =>
                onFieldChange('timeoutMs', event.target.value)
              }
            />
          </div>
          ...
          <div className="flex items-center justify-between rounded-none border p-2.5 text-xs">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                onFieldChange('tlsEnabled', checked)
              }
            />
          </div>
